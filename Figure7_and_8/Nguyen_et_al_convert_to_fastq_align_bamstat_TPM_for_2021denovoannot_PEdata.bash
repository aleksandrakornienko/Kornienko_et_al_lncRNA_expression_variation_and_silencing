...
#export sample_table=/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/Vu_s_data/InfoDataSingleEnd.txt
export sample_table=/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/Vu_s_data/InfoDataPairEnd.clean.txt


export name_accession=`cat $sample_table | sed -n $numberofline,"$numberofline"p  | awk '{print $1".rep"$2}'`
export unmapped_BAM1=`cat $sample_table | sed -n $numberofline,"$numberofline"p  | awk '{print $3}'`
echo $name_accession
echo $unmapped_BAM1


export unmapped_bamfile=$data_folder/$unmapped_BAM1
echo $unmapped_bamfile 
java -jar ${EBROOTPICARD}/picard.jar SamToFastq I=$unmapped_bamfile      FASTQ=$working_folder/fastq/$name_accession.R1.fastq  SECOND_END_FASTQ=$working_folder/fastq/$name_accession.R2.fastq

#align
export R1_lane1=$working_folder/fastq/$name_accession.R1.fastq
export R2_lane1=$working_folder/fastq/$name_accession.R2.fastq
...
STAR --readFilesIn $R1_lane1  $R2_lane1 \
--runThreadN 4 \
--alignIntronMax 6000 \
...
--outFilterMismatchNoverLmax 0.3 --outFilterScoreMinOverLread 0.4 --outFilterMatchNminOverLread 0.4 \
