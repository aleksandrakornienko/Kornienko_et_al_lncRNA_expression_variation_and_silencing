...
#wc -l /groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/saturation_curve/eracaps_sat_curve/names_of_points_eracaps_sat_curve.txt
#192 /groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/saturation_curve/eracaps_sat_curve/names_of_points_eracaps_sat_curve.txt

export point=`sed "${numberofline}q;d" $points_list`
...
export assemblies_for_merge=$assemblies_list_folder/$point.assemblies_for_merge.txt

################################
#### only change this: 
export name_assembly=$point
echo $name_assembly
#the folder where the output annotation will be :
export  working_folder=/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/saturation_curve/eracaps_sat_curve/merge_2021/$name_assembly
...
cuffmerge --keep-tmp -s $genome --min-isoform-fraction 0 -p 4 -o $working_folder $assemblies_for_merge
