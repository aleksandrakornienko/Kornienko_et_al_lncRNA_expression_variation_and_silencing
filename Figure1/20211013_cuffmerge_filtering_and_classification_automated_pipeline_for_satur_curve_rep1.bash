...
let "accN=$numberofline*10"
echo $accN
################################
#### only change this: 
export name_assembly=satur_curve.$accN.accessions.$rep
echo $name_assembly
#the folder where the output annotation will be :
export  working_folder=/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/saturation_curve/20211013_annot/$name_assembly
mkdir $working_folder
cd $working_folder


export accessions=/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/saturation_curve/shuffled_accessions/$rep/$accN.accessions.names.txt
cat $accessions | awk -v OFS="\t" '{print "/groups/nordborg/projects/cegs/alexandra/2020_lncRNA_paper/01_lncRNA_identification/tr_assembly/stringtie_2021/pool.1001G."$1"/pool.1001G."$1".stringtie.filtered.gtf"}' > $working_folder/$name_assembly.assemblies_for_merge.txt
