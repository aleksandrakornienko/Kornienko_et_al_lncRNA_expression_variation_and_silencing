...
pollen=$folder_ident_pipeline/assemblies_merge_pollen_eracaps_may.txt
flower=$folder_ident_pipeline/assemblies_merge_flower_eracaps_may.txt
seedling_eracaps=$folder_ident_pipeline/assemblies_merge_seedling_eracaps_may.txt
seedling_cortijo=$folder_ident_pipeline/assemblies_merge_seedling_cortijo_may.txt
rosette_eracaps=$folder_ident_pipeline/assemblies_merge_rosette_eracaps_may.txt
rosette_1001g=$folder_ident_pipeline/assemblies_merge_rosette_1001G_may.txt
rosette_1001gnew=$folder_ident_pipeline/assemblies_merge_rosette_1001Gnew_may.txt
#rosette_1001g_pools=$folder_ident_pipeline/assemblies_merge_rosette_1001G_pools.txt

#merging X different assemblies
################################
...
/groups/nordborg/projects/cegs/alexandra/software/gtfToGenePred $working_folder/$samples/transcripts.nodots.gtf $working_folder/$samples/transcripts.genepred
/groups/nordborg/projects/cegs/alexandra/software/genePredToBed $working_folder/$samples/transcripts.genepred $working_folder/$samples/transcripts.bed
cat $working_folder/$samples/transcripts.bed| awk -v OFS="\t"  '{$7=$2;print $0}'| sed -e 's/chloroplast/ChrC/g'| sed -e 's/mitochondria/ChrM/g'  > $working_folder/$samples/$samples.cfm.merged.bed
cat $working_folder/$samples/$samples.cfm.merged.bed | grep Chr4 > /groups/nordborg/user/aleksandra.kornienko/Documents/01_POSTDOC/03_Projects/2018_lncRNA_variation_paper/01_lncRNA_identification/01_Identification_pipeline/$name_assembly/$samples.cfm.merged.chr4.bed
...
# choose 2-step Cuffmerge without pools 
