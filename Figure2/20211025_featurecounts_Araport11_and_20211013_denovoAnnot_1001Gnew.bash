...
export list_samples=/groups/nordborg/user/aleksandra.kornienko/Documents/01_POSTDOC/03_Projects/RNA-seq_data/1001G_additional_samples/1001Gnew_sampnames_pools.txt
#wc -l /groups/nordborg/user/aleksandra.kornienko/Documents/01_POSTDOC/03_Projects/RNA-seq_data/1001G_additional_samples/1001Gnew_sampnames_pools.txt
#86 /groups/nordborg/user/aleksandra.kornienko/Documents/01_POSTDOC/03_Projects/RNA-seq_data/1001G_additional_samples/1001Gnew_sampnames_pools.txt
export sample=`sed -n $numberofline,"$numberofline"p $list_samples | awk '{print $1}'`
echo $sample
export bamfolder=/groups/nordborg/user/aleksandra.kornienko/analyses/1001G_additional_samples/BAM
